...
void PrepareHistosMuSF2018(){

  // For ID
  MergeHistos("Mu_RunABCDIDSF_2018.root","Mu_TightIDSF.root",
	      "NUM_TightID_DEN_TrackerMuons_pt_abseta_syst");

  // For ISO
  MergeHistos("Mu_RunABCDISOSF_2018.root","Mu_TightISOSF.root",
	      "NUM_TightRelIso_DEN_TightIDandIPCut_pt_abseta_syst");

  // For Trigger
  MergeHistos("Mu_TriggerSF_2018_BeforeMuonHLTUpdate.root","Mu_TriggerSF.root",
