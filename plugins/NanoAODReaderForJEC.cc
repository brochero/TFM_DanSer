...
void NanoAOD::Init(TTree *tree, TString b_Syst, bool IsMC, bool IsTop){
   ...
   if(b_Syst == "JEC"){
     ...
     const std::vector<TString> vJEC_JES = {"AbsoluteStat","AbsoluteScale","AbsoluteMPFBias",
					    "Fragmentation",
     ...
     for (unsigned int ijes=0; ijes<vJEC_JES.size(); ijes++){
       std::cout << "Loading " << "jet_JES"+vJEC_JES.at(ijes) << " branches..." << std::endl;
       fChain->SetBranchAddress("jet_JES"+vJEC_JES.at(ijes)+"Up",   jet_pt_JEC[ijes][0], &b_jet_pt_JEC[ijes][0]);
       fChain->SetBranchAddress("jet_JES"+vJEC_JES.at(ijes)+"Down", jet_pt_JEC[ijes][1], &b_jet_pt_JEC[ijes][1]);
     }

     // JER
     std::cout << "Loading " << "jet_JER" << " branches..." << std::endl;
     fChain->SetBranchAddress("jet_JERUp",   jet_pt_JEC[25][0], &b_jet_pt_JEC[25][0]); // Up
     fChain->SetBranchAddress("jet_JERDown", jet_pt_JEC[25][1], &b_jet_pt_JEC[25][1]); // Dw
     fChain->SetBranchAddress("jet_pt",      jet_pt_JEC[26][0], &b_jet_pt_JEC[26][0]); // Nm
   }
   // -------------------------------------------------------------------------------------------
   // -------------------------------------------------------------------------------------------
